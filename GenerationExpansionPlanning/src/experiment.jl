...
function run_experiment(data::ExperimentData, optimizer_factory, line_capacities_bidirectional::Bool, dendrogram::Vector, bound_alpha_factor, config::Dict{Symbol,Any}, results_df::DataFrame, run::Int64, time_steps)::ExperimentResult
    ...
    push!(results_df,  (run, false, objective, time, time_steps, 0.0))
