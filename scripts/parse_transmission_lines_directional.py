...
df = pd.read_csv("case_studies/2_locations/inputs/transmission_lines.csv")
...
df_combined.to_csv("case_studies/2_locations/inputs/transmission_lines2.csv", index=False)