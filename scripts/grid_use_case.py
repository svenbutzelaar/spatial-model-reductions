...
new_demand_df.to_csv('case_studies/grid/inputs/demand.csv', index=False)
...
new_generation_availability_df.to_csv('case_studies/grid/inputs/generation_availability.csv', index=False)
...
new_generation_df.to_csv('case_studies/grid/inputs/generation.csv', index=False)
...
new_transmission_df.to_csv('case_studies/grid/inputs/transmission_lines.csv', index=False)
